...
export default function TopBar({selectedProject, userName, env}) {
  ...
  const logoutUser = () => {
    ...
    Cookies.set('accessToken', '', { expires: new Date(0),domain: '.startagi.khulnasoft.com', path: '/'});
    Cookies.set('Source', 'app.startagi', {domain: '.startagi.khulnasoft.com', path: '/'});
    Cookies.set('mixpanel_initialized', 'false', {domain: '.startagi.khulnasoft.com', path: '/'});
    refreshUrl();
    router.reload();
  };
  ...
  function handleClick (option) {
    if (option === 'Models') {
      ...
      window.location.href = 'https://models.startagi.khulnasoft.com'
    } else {
    ...
    <div className="top_bar">
      ...
      <div className="top_right">
        <div className="horizontal_container gap_20">
          <div className="horizontal_container w_fit_content cursor_pointer gap_4" onClick={() => {window.open("https://startagi.khulnasoft.com/docs", "_blank"); getUserClick('StartAGI Docs Visited', {})}}>
          ...
          <div className="horizontal_container w_fit_content cursor_pointer gap_4" onClick={() => window.open("https://github.com/KhulnaSoft/StartAGI", "_blank")}>
