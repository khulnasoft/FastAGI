...
export default function MarketplacePublic({env}) {
  const handleSignupClick = () => {
    if (env === 'PROD') {
      const url = localStorage.getItem('marketplace_tab') === 'market_models' ? 'https://models.startagi.khulnasoft.com/' : 'https://app.startagi.khulnasoft.com/';
  ...
  return (
    <div style={{height: '100vh', width: '100%'}}>
      <div className={styles.marketplace_public_container}>
        <div className="startAgiLogo" style={{paddingLeft: '15px'}}><Image width={132} height={24}
